package cn.ipanel.apps.xpress.edition.boss.util;
...
public class IpHelper {
    ...
    public static boolean isInnerIp(String ipAddress) {
        return !Globals.isBlank(ipAddress) && (ipAddress.startsWith("127") || ipAddress.startsWith("192.168") || ipAddress.startsWith("10."));
    }
