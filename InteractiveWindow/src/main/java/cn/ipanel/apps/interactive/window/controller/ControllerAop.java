...
import cn.ipanel.apps.interactive.window.global.*;
import cn.ipanel.apps.interactive.window.util.IpHelper;
...
public class ControllerAop {
	...
	@Pointcut(value = "execution(public cn.ipanel.apps.interactive.window.controller.resp.Result *(..))")
