...
public class Globals {
    ...
    public static final String PRODUCT_EN_NAME = "product";
    public static final String PRODUCT_NAME = "产品";
    public static final String GOODS_EN_NAME = "goods";
    public static final String GOODS_NAME = "商品";
    ...
    public static String getMouldButtonName(MouldInfo mouldInfo, String button) {
        final String buttonName = button + "Name";
        if (null != mouldInfo) {
            Field[] fields = mouldInfo.getClass().getDeclaredFields();
            for (Field field : fields) {
                field.setAccessible(true);
                if (field.getName().equals(buttonName)) {
                    try {
                        return field.get(mouldInfo).toString();
                    } catch (IllegalAccessException e) {
                        log.error("by luzh: getButtonName error: {}", e.getMessage(), e);
                    }
                }
            }
        }
